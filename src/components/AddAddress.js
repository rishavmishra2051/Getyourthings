    ...
    return (
        <div>
            <div className="fixed inset-0 flex items-center justify-center z-50">
                <div className="fixed inset-0 bg-white opacity-100 overflow-y-auto max-h-screen">
                    <CloseOutlinedIcon onClick={() => { props.setAddAddress(); }} className="absolute top-0 right-0 font-semibold text-3xl cursor-pointer border border-red-600 bg-red-600" />
                    <div className='flex justify-center items-center'>
                        <div className='font-titleFont font-semibold p-2 m-2'>
                            <h2 className="text-2xl text-center font-semibold my-2"><u>Add New Address</u></h2>
